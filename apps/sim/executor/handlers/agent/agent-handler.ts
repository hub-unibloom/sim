...
import { AffectiveVector } from '@/lib/memory/types'
...
export class AgentBlockHandler implements BlockHandler {
  ...
  private async buildMessages(
    ...
    // 8. INFINITE MEMORY INJECTION (Cheshire Integration)
    // We purposefully inject this *after* standard system prompts but *before* user messages
    // to ensure the "Identity Core" and "Memories" ground the agent's persona.
    try {
